...
export default function Page() {
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-6">
      ...
      <GroupTable title="Group - A" data={Female_Juniors_Round1_GroupA} />
      <GroupTable title="Group - B" data={Female_Juniors_Round1_GroupB} />
      ...
      <Round2GroupTable title="Group - A" data={Female_Juniors_Round2_GroupA} />
      <Round2GroupTable title="Group - B" data={Female_Juniors_Round2_GroupB} />
