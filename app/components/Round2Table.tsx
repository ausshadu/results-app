          ...
          <tbody className="text-zinc-800">
            {data.map((r, i) => (
              ...
              >
                ...
                <td className="px-3 py-2 border border-zinc-300">{r.q4}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q5}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q6}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q7}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q8}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q9}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q10}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q11}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q12}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q13}</td>
                <td className="px-3 py-2 border border-zinc-300">{r.q14}</td>
